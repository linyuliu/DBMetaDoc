...
class DocumentTableLayoutCalculatorTest {
    ...
    void shouldClampBasicColumnBudgetsAndKeepRatiosStable() {
        ...
        assertBudgetBetween(layout.getColumns().get(0), 5, 6);
        assertBudgetBetween(layout.getColumns().get(1), 10, 18);
        assertBudgetBetween(layout.getColumns().get(2), 9, 15);
        assertBudgetBetween(layout.getColumns().get(3), 6, 7);
        assertBudgetBetween(layout.getColumns().get(4), 6, 7);
        ...
        assertTrue(layout.getColumns().get(3).getWidthRatio() > layout.getColumns().get(0).getWidthRatio());
        assertTrue(layout.getColumns().get(4).getWidthRatio() > layout.getColumns().get(0).getWidthRatio());
    ...
    void shouldIncreaseRowLinesForLongIndexAndForeignKeyRows() {
        ...
        assertBudgetBetween(indexLayout.getColumns().get(2), 6, 7);
    }
